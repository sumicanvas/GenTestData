...
```sh
npm run scenario:4 -- --shcode 005380 --dgubun 7 --query "현대" --limit 5
```
...
package.json
package-lock.json
src_scenario/common.js
src_scenario/scenario01_all_news.js
src_scenario/scenario02_news_source.js
src_scenario/scenario03_stock_keyword.js
src_scenario/scenario04_stock_source_keyword.js
src_scenario/scenario05_stock_only.js
src_scenario/scenario06_stock_source.js
src_scenario/scenario07_keyword.js
src_scenario/scenario08_source_keyword.js
src_scenario/scenario09_fuzzy.js
src_scenario/scenario10_highlight.js
src_scenario/README.md
