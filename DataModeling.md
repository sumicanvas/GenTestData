...
| `NEWS_MAST.YMD` | PK 기준 |
| `NEWS_MAST.NEWSCODE` | PK 기준 |
| `NEWS_JMCODE.SEQNO` | `NEWS_MAST.SEQNO` 참조 |
| `NEWS_JMCODE.YMD` | `NEWS_MAST.YMD` 참조 |
| `NEWS_JMCODE.NEWSCODE` | `NEWS_MAST.NEWSCODE` 참조 |
| `NEWS_CONT_P.SEQNO` | `NEWS_MAST.SEQNO` 참조 |
| `NEWS_CONT_P.YMD` | `NEWS_MAST.YMD` 참조 |
| `NEWS_CONT_P.NEWSCODE` | `NEWS_MAST.NEWSCODE` 참조 |
